...
import com.example.a1valetdevices.databinding.LayoutRecentReleasesBinding
import com.example.a1valetdevices.models.Device

class RecentReleasesViewHolder(val binding: ItemSingleDeviceBinding): RecyclerView.ViewHolder(binding.root) {
